...
import projecto.jhpiego.psm.conection.DAOGeneratorFour;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  FirebaseDatabase.getInstance().setPersistenceEnabled(true);
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                GeneratorFour generatorFour = new GeneratorFour(
                ...
                if (txtCapacity.getText().toString().isEmpty() || txtFreqPM.getText().toString().isEmpty() || txtNameOfMant.getText().toString().isEmpty()) {
                    ...
                    dao.add(generatorFour).addOnCompleteListener(suc ->{
