...
import projecto.jhpiego.psm.conection.DAOGeneratorOne;
...
public class FormGeneratorOne extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DAOGeneratorOne dao = new DAOGeneratorOne();
      //  FirebaseDatabase.getInstance().setPersistenceEnabled(true);

        btnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(FormGeneratorOne.this, TelaPrincipal.class);
                startActivity(i);
            }
        });
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                GeneratorOne generatorOne = new GeneratorOne(
                ...
                if (txtCapacity.getText().toString().isEmpty() || txtFreqPM.getText().toString().isEmpty() || txtNameOfMant.getText().toString().isEmpty()) {
                    ...
                    dao.add(generatorOne).addOnCompleteListener(suc ->{
