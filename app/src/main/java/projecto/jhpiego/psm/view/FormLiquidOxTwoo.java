...
import projecto.jhpiego.psm.conection.DAOLiquiOxTankTwoo;
...
public class FormLiquidOxTwoo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                LiquiOxTankTwoo liquiOxTankTwoo = new LiquiOxTankTwoo (
                ...
                if (txtAVGLOX.getText().toString().isEmpty() ||txtMCLOX.getText().toString().isEmpty() ||txtOtherLOX.getText().toString().isEmpty()||
                    ...
                    dao.add(liquiOxTankTwoo).addOnCompleteListener(suc -> {
