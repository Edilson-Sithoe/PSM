...
public class TelaPrincipal extends AppCompatActivity {
    ...
    private Button btn_inventory_view, btn_interview, btn_infrastrutura, btn_med_gas_system, btn_logistic;
    private Button tn_med_equipment, btn_spervisory, btn_training_program, btn_equip_inventory;
 /*   private Button btn_electricity, btn_generatorOne, btn_generatorTwoo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_inventory_view.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent interviw = new Intent(TelaPrincipal.this, FormHealthFacility_View.class);
       ...
       /* btn_identInter.setOnClickListener(new View.OnClickListener() {
        ...
        idBtn_TEAM.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent formMAS = new Intent(TelaPrincipal.this, FormTeam.class);
                startActivity(formMAS);
            }
        });
        ...
        idBtn_DocTrainConc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent formConc = new Intent(TelaPrincipal.this, FormDocTrainConc.class);
                startActivity(formConc);
            }
        });
    ...
    private void InitializerComponents(){
        ...
        btn_inventory_view = findViewById(R.id.idBtnEquip_inv);
